<nav class="navbar navbar-default navbar-main navbar-light navbar-top">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right navbar-mob-left">
            ...
            @auth('customer')
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu nav-list">
                        <li>
                            <a href="{{ route('account', 'dashboard') }}"><i class="fa fa-dashboard fa-fw"></i> @lang('theme.nav.dashboard')
                            </a></li>
                        <li>
                            <a href="{{ route('account', 'orders') }}"><i class="fa fa-shopping-cart fa-fw"></i> @lang('theme.nav.my_orders')
                            </a></li>
                        <li>
                            <a href="{{ route('account', 'wishlist') }}"><i class="fa fa-heart-o fa-fw"></i> @lang('theme.nav.my_wishlist')
                            </a></li>
                        <li>
                            <a href="{{ route('account', 'disputes') }}"><i class="fa fa-rocket fa-fw"></i> @lang('theme.nav.refunds_disputes')
                            </a></li>
                        <li>
                            <a href="{{ route('account', 'coupons') }}"><i class="fa fa-tags fa-fw"></i> @lang('theme.nav.my_coupons')
                            </a></li>
                        {{-- <li><a href="{{ route('account', 'gift_cards') }}"><i class="fa fa-gift fa-fw"></i> @lang('theme.nav.gift_cards')</a></li> --}}
                        <li>
                            <a href="{{ route('account', 'account') }}"><i class="fa fa-user fa-fw"></i> @lang('theme.nav.my_account')
                            </a></li>
                        <li class="sep"></li>
                        <li>
            ...
            @else
                <li>
                    <a href="#nav-login-dialog" data-toggle="modal" data-target="#loginModal"><span>{{ trans('theme.sing_in') }}</span>{{ trans('theme.your_account') }}
                    </a></li>
            @endauth
    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="main-nav-collapse">
                    ...
                    <ul class="dropdown-menu menu-category-dropdown" aria-labelledby="dLabel">
                        @foreach($all_categories as $catGroup)
                            @if($catGroup->subGroups->count())
                                ...
                                <li>
                                    <a href="{{ route('categoryGrp.browse', $catGroup->slug) }}"><i class="fa {{ $catGroup->icon ?? 'fa-cube' }} fa-fw category-icon"></i>{{ $catGroup->name }}
                                    </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="{{ route('account', 'wishlist') }}" class="navbar-item-mergin-top"><i class="fa fa-heart-o hidden-xs"></i> {{ trans('theme.nav.wishlist') }}
                    </a>
                </li>
                <li>
                    <a href="{{ get_page_url(\App\Page::PAGE_CONTACT_US) }}" class="navbar-item-mergin-top" target="_blank">{{ trans('theme.nav.support') }}</a>
                </li>
